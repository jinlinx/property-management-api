...
export async function doJob(pupp: IPuppWrapper, opts: IPuppOpts): Promise<IChaseDownloadFileRet[]>{
    ...
    await sleep(1000);
    const url = 'https://secure07a.chase.com/web/auth/?fromOrigin=https://secure07a.chase.com';
    ...
    await waitAndFindOneCss(loginBoxCss);
