import { getClient, getClientCredsByEnv } from '@gzhangx/googleapi'
...
export async function getSheetClient(req: Request) {
    ...
    const cliInfo = getClientCredsByEnv('gzperm') as IRefresCreds;
    ...
    const client = await getClient(cliInfo);
    return client;
}
